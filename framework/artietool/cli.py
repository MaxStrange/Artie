...
def build_parser() -> argparse.ArgumentParser:
    """
    Construct the top-level Artie Tool argument parser.
    """
    # Set up parser
    ...
    group.add_argument("--artie-name", default=None, type=str, help="[Deployment, HW testing, Status, and Install] If not given, we automatically detect an Artie on the cluster. If you have more than one Artie, you should give the name of the Artie you want to interact with.")
    ...
    group.add_argument("--fail-fast", action='store_true', help="If given, we will stop the procedure on the first failure (including test case failures).")
...
def main():
    """
    Entry point for the `artie-tool` console script.
    """
    parser = build_parser()
