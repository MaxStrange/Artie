...
curl -sfL https://get.k3s.io | INSTALL_K3S_VERSION="v1.32.0-rc2+k3s1+git39f4cbb3367544477e9e678626c0add76e731624" INSTALL_K3S_EXEC="--write-kubeconfig-mode=644" sh -s - --docker
