...
class ServoSubmodule:
    ...
    def self_check(self):
        ...
        self.go(ebcommon.EyebrowSides.LEFT, self._left_servo_degrees)
        self.go(ebcommon.EyebrowSides.RIGHT, self._right_servo_degrees)
    ...
    def get(self, side: ebcommon.EyebrowSides) -> float:
    ...
    def go(self, side: ebcommon.EyebrowSides, servo_degrees: float) -> bool:
